...
class NewProductCreate extends Component {
  constructor(props) {
    ...
    this.CMPproductRef = React.createRef();
  }
    ...
    getAllBrands()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          this.setState({ brandOpt: options });
          if (isNew) {
    ...
    get_outlet_groups()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          let data = res.responseObject;
          let Opt = [];
          // Opt.push({ value: 0, label: "Add New" });
          data.map(function (data) {
            Opt.push({
              value: data.id,
    ...
    getAllSubCategory()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          // console.log("subCategoriesList>>>", Opt.length);
  ...
  validateProduct = (productName, packageId, setFieldValue) => {
  ...
  validate_product_code = (productCode) => {
    let requestData = new FormData();

    requestData.append("productCode", productCode);

    validate_product_code(requestData)
      .then((response) => {
        let res = response.data;
        if (res.responseStatus == 409) {
          MyNotifications.fire({
  ...
  componentDidMount() {
    ...
    if (AuthenticationCheck()) {
      ...
      //@vinit @source changed to focus the previous tab were we left
      ...
      .then((response) => {
        ...
        if (response.data.responseStatus == 200) {
          ...
          let initVal = {
            ...
            minStock: res.minStock != 0 ? res.minStock : 0.0,
            maxStock: res.maxStock != 0 ? res.maxStock : 0.0,
            ...
            selectedUnit:
              unitOpts != null && unitOpts != undefined
                ? res.selectedUnit
                  ? getSelectValue(unitOpts, res.selectedUnit)
                  : ""
                : "",
          };
          this.setState({
  ...
  // @harish @ On Escape key press  Modal will Close
                          ...
                          MyNotifications.fire(
                            {
                              ...
                              handleSuccessFn: () => {
                                ...
                                requestData.append(
                                  "minStock",
                                  values.minStock ? values.minStock : 0.0
                                );
                                requestData.append(
                                  "maxStock",
                                  values.maxStock ? values.maxStock : 0.0
                                );
                                ...
                                // let FmstPackaging = productrows.filter((v) => {
                                //   v["selectedLevelA"] =
                                //     levelA == true && v.levela_id != ""
                                //       ? v.levela_id.value
                                //       : "";
            ...
            {({
              ...
              >
                  ...
                  <div className=" inner-div-style">
                    <Row className="mx-0">
                              ...
                              onKeyDown={(e) => {
                                if (e.shiftKey && e.keyCode == 9) {
                                  ...
                                  if (
                                    ...
                                    // this.handleKeyDown(e, "productName");
                                    this.focusNextElement(e);
                                  }
                                }
                              }}
                      ...
                      <Col lg={4} md={4} sm={4} xs={4}>
                        <Row>
                          <Col lg={1} md={1} sm={1} xs={1} className="fpl">
                            <Form.Label>
                      ...
                      <Col lg={2} md={2} sm={2} xs={2}>
                        <Row>
                          <Col lg={3} md={3} sm={3} xs={3} className="fpl">
                    ...
                    <Row className="mx-0 mt-2">
                            ...
                            <Form.Control
                              ...
                              onKeyDown={(e) => {
                                if (e.shiftKey && e.keyCode == 9) {
                                  ...
                                  document
                                    .getElementById("barcodeSaleQuantity")
                                    .focus();
                                } else if (e.keyCode == 13) {
                                  handlesetFieldValue(
                                    setFieldValue,
                                  ...
                                  // this.handleKeyDown(e, "barcodeSaleQuantity");
                                  this.focusNextElement(e);
                                }
                              }}
                            ></Form.Control>
                      ...
                      <Col lg={1} md={1} sm={1} xs={1}>
                        <Row>
                          <Col lg={4} md={4} sm={4} xs={4} className="fpl">
                      ...
                      <Col lg={2} md={2} sm={2} xs={2}>
                        <Row>
                          <Col lg={2} md={2} sm={2} xs={2} className="fpl">
                      ...
                      <Col lg={2} md={2} sm={2} xs={2}>
                        <Row>
                          <Col lg={5} md={5} sm={5} xs={5} className="fpl ps-1">
                          ...
                          <Col lg={7} md={7} sm={7} xs={7} className="pe-2">
                            <MyTextDatePicker
                              ...
                              autoComplete="taxApplicableDate"
                              id="taxApplicableDate"
                              placeholder="DD/MM/YYYY"
                              dateFormat="dd/MM/yyyy"
                              value={values.taxApplicableDate}
                              onChange={handleChange}
                              // innerRef={(input) => (this.inputRefs[8] = input)}
                              onKeyDown={(e) => {
                                if (e.shiftKey && e.keyCode == 9) {
                    ...
                    <Row className="mx-0 mt-2">
                                ...
                                <Button
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.keyCode === 32) {
                                      ...
                                      this.focusNextElement(e);
                                      // this.SubGroupMdlRef.current?.focus();
                                    }
                                  }}
                                >
                                  <img
                                ...
                                <Select
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode == 9) {
                                      ...
                                      // this.handleKeyDown(e, "addCategory");
                                      this.focusNextElement(e);
                                    }
                                  }}
                                />
                                ...
                                <Button
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.keyCode == 32) {
                                      ...
                                      this.focusNextElement(e);
                                      // this.SubCategoryMdlRef.current?.focus();
                                    }
                                  }}
                                >
                                  <img
                      ...
                      <Col lg={2} md={2} sm={2} xs={2}>
                        <Row>
                          <Col lg={4} md={4} sm={4} xs={4} className="fpl ps-1">
                          ...
                          <Col lg={1} md={1} sm={1} xs={1}>
                            <Row>
                              ...
                              >
                                ...
                                // ref={values.isInventory == true ? (input) => (this.inputRefs[16] = input) : ""}
                                // ref={(input) => (this.inputRefs[16] = input)}
                                ></Form.Control>
                                <span className="text-danger errormsg">
                                  {errors.minStock}
                                </span>
                            ...
                            <Row>
                              ...
                              >
                                <Form.Control
                                  ...
                                  placeholder="Max"
                                  className="text-box-readonly text-box p-1 text-end"
                                  id="maxStock"
                                  name="maxStock"
                                  onChange={handleChange}
                                  onKeyPress={(e) => {
                          ...
                          {values.isSerialNo == true ? (
                            ...
                            <>
                              ...
                              >
                                ...
                                // ref={values.isInventory == false && values.isSerialNo == false ? (input) => (this.inputRefs[18] = input) : (input) => (this.inputRefs[20] = input)}
                                />
                              </Col>
                            </>
                          )}
                                  ...
                                  <Row>
                                    ...
                                    >
                                      <Form.Check
                                        ...
                                        // onChange={(e) => {
                                        //   values.opn_stock == values ? false : true
                                        // }}
                                        onClick={(e) => {
                                          if (e.target.checked) {
                                    ...
                                    {values.isWarranty == true ? (
                                      ...
                                      >
                                        ...
                                        // ref={values.isBatchNo == false && values.isSerialNo == true ? (input) => (this.inputRefs[22] = input) : null}
                                        />
                                      </Col>
                                    ) : (
                                      ""
                ...
                <div>
                  ...
                  // CMPproductRef={this.CMPproductRef}
                  />
                </div>
                        ...
                        MyNotifications.fire(
                          {
                            ...
                            handleSuccessFn: () => {
                              ...
                              if (
                                ...
                                // if (this.props.block.prop_data.prop_data.id !== undefined) {
                                  ...
                                  createHSN(requestData)
                                    .then((response) => {
                                      ...
                                      if (res.responseStatus == 200) {
                                        ...
                                        setTimeout(() => {
                                          document
                                            .getElementById("PC_hsn_submit_btn")
                                            .focus();
                                        }, 2000);
                                      } else {
                                        MyNotifications.fire({
                            ...
                            createBrand(requestData)
                              .then((response) => {
                                ...
                                if (res.responseStatus == 200) {
                                  ...
                                  setTimeout(() => {
                                    document
                                      .getElementById("PC_brand_submit_btn")
                                      .focus();
                                  }, 2000);
                                } else {
                                  MyNotifications.fire({
                              ...
                              createCategory(requestData)
                                .then((response) => {
                                  ...
                                  if (res.responseStatus == 200) {
                                    ...
                                    setTimeout(() => {
                                      document
                                        .getElementById("PC_cate_submit_btn")
                                        .focus();
                                    }, 2000);
                                  } else {
                                    MyNotifications.fire({
                            ...
                            <Form.Control
                              ...
                              onKeyDown={(e) => {
                                if (e.shiftKey && e.keyCode == 9) {
                                  ...
                                  if (e.target.value.trim())
                                    document
                                      .getElementById("PC_sub_cate_submit_btn")
                                      .focus();
                                  else e.preventDefault();
                              }}
                            />
                              ...
                              createSubGroup(requestData)
                                .then((response) => {
                                  ...
                                  if (res.responseStatus == 200) {
                                    ...
                                    setTimeout(() => {
                                      document
                                        .getElementById("PC_sub_grp_submit_btn")
                                        .focus();
                                    }, 2000);
                                  } else {
                                    MyNotifications.fire({
                            ...
                            createPacking(requestData)
                              .then((response) => {
                                ...
                                if (res.responseStatus == 200) {
                                  ...
                                  setTimeout(() => {
                                    document
                                      .getElementById("PC_pkg_submit_btn")
                                      .focus();
                                  }, 2000);
                                } else {
                                  MyNotifications.fire({
