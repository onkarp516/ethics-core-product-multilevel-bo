...
export default class Role extends Component {
  ...
  validateUserRoleDuplicate = (roleName, setFieldValue) => {
    let reqData = new FormData();
    reqData.append("roleName", roleName);
    validateUsersRole(reqData)
      .then((response) => {
        let res = response.data;
        ...
        <div id="example-collapse-text" className="usercreatestyle">
          <div className="m-0">
            ...
            <Formik
              ...
              //   roleName: Yup.string().nullable().required("Required"),
              // })}
                          ...
                          .then((response) => {
                            ...
                            if (res.responseStatus == 200) {
                              ...
                              eventBus.dispatch("page_change", {
                                ...
                                isCancel: true,
                                prop_data: {
                                  roleId: parseInt(res.responseObject),
                                },
                              });
                            } else {
                            ...
                            <Row className="mt-2">
                              <Col lg={1} className="text-end my-auto">
                                <Form.Label className="form_label">
                                  Role
                                  <span className="text-danger red_label">
                                    *
                                  </span>
                                </Form.Label>
                              </Col>
                                    ...
                                    onKeyDown={(e) => {
                                      if (e.shiftKey && e.keyCode == 9) {
                                        ...
                                        if (
                                          ...
                                          this.validateUserRoleDuplicate(
                                            values.roleName,
                                            setFieldValue
                                          );
                                          setFieldValue(
                    ...
                    <Row className="mt-2 mb-1 me-2">
                      <Col md="12" className="text-end mt-1">
                        ...
                        <Button
                          id="roleC_can_btn"
                          variant="secondary"
                          className="cancel-btn me-2 ms-2"
                          onClick={(e) => {
                            e.preventDefault();
