...
export default class PurchaseRegister2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      previous_page_data: "",
  ...
  get_profit_and_loss_ac_details_step2 = () => {
    ...
    get_pur_register_details(data)
      .then((response) => {
        if (response.data.responseStatus === 200) {
          let resultDebit = response.data.debit;
          let resultCredit = response.data.credit;
          console.log("result1111", resultDebit);
          this.setState({
            isEditDataSet: true,
            profitstep2: resultDebit,
            creditDate: resultCredit,
            opening_bal: response.data.opening_bal,
            startDate: moment(
      ...
      <div className="report-form-style">
        ...
        <div className="report-list-style">
          <Table className="m-0">
            ...
            <tbody style={{ borderTop: "2px solid #C7CFE; importent" }}>
