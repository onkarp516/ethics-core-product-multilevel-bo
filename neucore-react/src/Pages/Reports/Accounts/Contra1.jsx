...
import { get_monthwise_contra_details } from "@/services/api_functions";
import {
  MyDatePicker,
  eventBus,
  AuthenticationCheck,
...
export default class Contra1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      profitstep1: [],
  ...
  get_profit_and_loss_ac_details_on_date_change_of_user = () => {
    ...
    get_monthwise_contra_details(data)
      .then((response) => {
