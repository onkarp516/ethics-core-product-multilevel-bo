...
import { get_profit_and_loss_ac_details_step2 } from "@/services/api_functions";
import {
  MyDatePicker,
  eventBus,
  AuthenticationCheck,
...
export default class DayBookReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      previous_page_data: "",
  ...
  get_profit_and_loss_ac_details_on_date_change_of_user = () => {
    ...
    get_profit_and_loss_ac_details_step2(data)
      .then((response) => {
    ...
    return (
      <div className="report-form-style">
        <Row style={{ background: "#E6F2F8" }}>
          ...
          <Col>
            <h4 className="mb-0 ps-3 py-3 companyName text-center">DAY BOOK</h4>
          </Col>
        </Row>
        <hr className="my-0" />
        <Row style={{ background: "#E6F2F8" }}>
