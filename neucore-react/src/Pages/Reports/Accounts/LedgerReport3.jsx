...
import {
  get_balance_ac_step4,
  get_tranx_detail_of_month,
} from "@/services/api_functions";

export default class LedgerReport3 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      previous_page_data: "",
  ...
  previousPageProfit4 = () => {
    ...
    eventBus.dispatch("page_change", {
      ...
      prop_data: {
        ...
        rules_type: edit_data.rules_type,
  ...
  get_profit_and_loss_ac_details_on_date_change_of_user = () => {
    ...
    get_tranx_detail_of_month(data)
      .then((response) => {
