...
import {
  ...
  getLedgers,
  get_monthwise_batch_stock_details,
...
export default class BatchStock2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      profitstep1: [],
  ...
  get_profit_and_loss_ac_details_on_date_change_of_user = () => {
    ...
    data.append("batchno", edit_data.batchno);
    get_monthwise_batch_stock_details(data)
      .then((response) => {
