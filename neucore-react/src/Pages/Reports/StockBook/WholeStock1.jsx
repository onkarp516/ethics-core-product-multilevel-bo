...
export default class WholeStock1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      profitstep1: [],
      ...
      .then((response) => {
        ...
        if (res.responseStatus === 200) {
          this.setState(
            ...
            () => {
              console.log("stocklist", this.state.stocklst);
                ...
                stocklst.map((v, i) => {
                  return (
                    ...
                    >
                      ...
                      {/* {JSON.stringify(v.product_unit_data)} */}
                      {v.product_unit_data.length > 0 ? (
                        v.product_unit_data.map((k, j) => {
                          return (
                            <>
                              <td
                                className="wholetblstyle text-center"
                                style={{ borderRight: "1px solid #C7CFE0" }}
                              >
                                {k.closing_stock == 0 ? "" : k.closing_stock}
                              </td>
                              ...
                              <td className="wholetblstyle text-center"></td>
                              {/* <td
                        className="text-center"
                        style={{
                          borderRight: "1px solid #C7CFE0",
