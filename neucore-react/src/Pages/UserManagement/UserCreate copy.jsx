              ...
              {({
                ...
                <Form onSubmit={handleSubmit}>
                  <div>
                              ...
                              <Col md="2">
                                <Form.Group>
                                  ...
                                  <Select
                                    ...
                                    onChange={(v) => {
                                      if (v != null) {
                                        this.setState({ userType: v.value });
                                      } else {
                    ...
                    {userType != "" && userType == "1" ? (
                      <div className="emp-detail-style mt-4">
                          ...
                          <Col md="2">
                            <Form.Group>
                              ...
                              <MyDatePicker
                                ...
                                onChange={(date) => {
                                  setFieldValue("dateofregistartion", date);
                                }}
                                selected={values.dateofregistartion}
                                className="date-style height-date-style"
                                maxDate={new Date()}
                              />
                            </Form.Group>
                            <span className="text-danger">
