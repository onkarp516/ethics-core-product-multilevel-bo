...
export default class TransactionPrint extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="wrapper_div" style={{ height: "83vh" }}>
        ...
        <Modal
          show={printModalShow1}
          size="lg"
          className="transaction_mdl invoice-mdl-style"
          onHide={() =>
            this.setState({ printModalShow: true, printModalShow1: false })
          }
          aria-labelledby="contained-modal-title-vcenter"
          centered
        >
          ...
          <Modal.Footer>
            <Button
              ...
              onClick={(e) => {
                e.preventDefault();
                eventBus.dispatch("page_change", "utilites_print_preview");
                // this.setState({ printModalShow: true });
              }}
            >
              Print
