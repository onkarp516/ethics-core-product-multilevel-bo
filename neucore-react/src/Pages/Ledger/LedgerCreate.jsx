...
class LedgerCreate extends React.Component {
  constructor(props) {
    ...
    this.mdlInvDateRef = React.createRef();
        ...
        MyNotifications.fire(
          {
            ...
            icon: "warning",
            title: "Warning",
            msg: "Balance Amount is greater than Zero",
            // is_button_show: true,
            is_timeout: true,
            delay: 1500,
          },
      ...
      this.setState(
        ...
        () => {
          if (this.openingBalRef.current) {
            ...
            this.openingBalRef.current.setFieldValue("invoice_no", values.invoice_no);
            this.openingBalRef.current.setFieldValue("invoice_date", values.invoice_date);
            this.openingBalRef.current.setFieldValue("due_date", values.due_date);
            this.openingBalRef.current.setFieldValue("due_days", values.due_days);
            this.openingBalRef.current.setFieldValue("bill_amt", values.bill_amt);
            this.openingBalRef.current.setFieldValue("invoice_paid_amt", values.invoice_paid_amt);
            this.openingBalRef.current.setFieldValue("invoice_bal_amt", values.invoice_bal_amt);
            // this.openingBalRef.current.setFieldValue("type", "");
          }
        }
      );
  ...
  finalInvoiceRemainingAmt = () => {
    ...
    if (billAmt > 0 || paidAmt > 0) {
      if (parseFloat(billAmt) >= parseFloat(paidAmt)) {
  ...
  invoiceRemaningValidation = (billAmt, paidAmt) => {
    if (parseInt(paidAmt) > parseInt(billAmt)) {
      MyNotifications.fire(
        {
          show: true,
          icon: "warning",
                      ...
                      if (values.dept == "" && deptList.length == 0) {
                        ...
                        if (deptList.length == 0) {
                          MyNotifications.fire({
                            ...
                            icon: "error",
                            title: "Error",
                            msg: "Please Add  Department / Clear. ",
                            is_button_show: true,
                            // is_timeout: true,
                            // delay: 1000,
                          });
                                        ...
                                        prop_data: {
                                          ...
                                          searchValue:
                                            this.props.block.prop_data
                                              .searchValue,
                                          createId:
                                            this.props.block.prop_data.createId,
                                        },
                                      },
                                    });
                                  }
                    ...
                    <Card className="top_card_style">
                      <Card.Body>
                        <Row>
                          ...
                          <Col lg={3} className="">
                            <Row>
                              <Col lg={2} className="my-auto normalP pe-0">
                                ...
                                <Form.Group>
                                  <Form.Control
                                    ...
                                    onBlur={(v) => {
                                      ...
                                      v.target.value = handleDataCapitalised(v.target.value);
                                      handlesetFieldValue(
                                        setFieldValue,
                                        "ledger_name",
                                        v.target.value
                                    ...
                                    <Col lg={6}>
                                      ...
                                      >
                                        <Select
                                          ...
                                          id="opening_balancing_method_sundry_creditors"
                                    ...
                                    <Col lg={6}>
                                      ...
                                      >
                                        <Select
                                          ...
                                          id="opening_balancing_method_sundry_debtors"
                                          name="opening_balancing_method"
                                          // styles={customStyles}
                                          styles={ledger_select}
                                          options={balancingOpt}
                          ...
                          <Card className="middle_card">
                            <Card.Body>
                              <Row>
                                ...
                                <Col lg={2} className="">
                                  <Row>
                                    <Col lg={3} className="my-auto fLp pe-0">
                                  ...
                                  <Col md={2}>
                                    <Form.Group
                                      onKeyDown={(e) => {
                                        if (e.keyCode == 13) {
                                          if (
                                            values.hasOwnProperty("isTaxation")
                                          ) {
                                            if (values.isTaxation.value) {
                  ...
                  >
                              ...
                              <Form.Group>
                                <MyTextDatePicker
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.key == "Tab") {
                                      // e.preventDefault();
                                      this.handleKeyDown(e, "submit_sale");
                                    } else if (e.keyCode == 13) {
                                      e.preventDefault();
                                      this.handleKeyDown(e, "submit_sale");
                                    }
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (dobDate > todayDate) {
                                      MyNotifications.fire({
                                        ...
                                        icon: "warning",
                                        title: "Warning",
                                        msg: "DOB should be less than today date",
                                        // is_button_show: false,
                                        is_timeout: true,
                                        delay: 1500,
                                      });
                    ...
                    <Modal.Footer className="border-0">
                      <Button
                        ...
                        type="submit"
                        id="submit_sale"
                        // disabled={(values.first_name == "" && values.mobile_number == "") ? true : false}
                      >
                        Submit
                      </Button>
                      <Button
                                ...
                                <Form.Control
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode === 9) {
                                      ...
                                      this.handleKeyDown(e, "area_pincode");
                                    } else if (e.keyCode === 13) {
                                      this.handleKeyDown(e, "area_pincode");
                                    }
                                  }}
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode == 9) {
                                      ...
                                      if (pincode_val !== "") {
                                        ...
                                        this.handleKeyDown(e, "area_submit");
                                      } else {
                                        e.preventDefault();
                                      }
                                    } else if (e.keyCode == 13) {
                                        ...
                                        onKeyDown={(e) => {
                                          if (e.keyCode == 18) {
                                            ...
                                            if (
                                              ...
                                              setTimeout(() => {
                                                this.mdlInvDateRef.current?.focus();
                                              }, 1000);
                                            }
                                    ...
                                    <Col lg={8}>
                                      <Form.Group>
                                        <Form.Control
                                          ...
                                          onKeyDown={(e) => {
                                            if (e.key === "Tab") {
                                              this.invoiceRemaningValidation(
                                                values.bill_amt,
                                                e.target.value
                                              );
                                              // e.preventDefault();
