...
class LedgerCreate extends React.Component {
      ...
      this.setState({ source: prop_data }, () => {
        ...
        if (prop_data != null) {
          this.myRef.current.setFieldValue(
            "underId",
            getSelectValue(this.state.undervalue, prop_data.ledgerId)
          );
          console.log("prop_data.ledgerType", prop_data.ledgerType);
        }
      });
    }
  }
  ...
  addOpeningBalRow = (values) => {
    ...
    let paidAmt = parseInt(this.finalBillpaidBal() + parseInt(invoiceBalAmt));
  ...
  finalInvoiceRemainingAmt = () => {
    ...
    let paidAmt = this.state.invoicePaidBal;
    if (billAmt != 0) {
      return isNaN(parseFloat(billAmt) - parseFloat(paidAmt))
        ? 0
                            ...
                            <Col lg={4} md={3} sm={3} xs={3}>
                              <Row>
                                <Col
                                  ...
                                  className="ps-0"
                                >
                                  <Form.Label>Paid Balance</Form.Label>
                                </Col>
                                <Col lg={8} md={8} sm={8} xs={8}>
                                  <Form.Group>
                                    <Form.Control
                            ...
                            <Col lg={4} md={3} sm={3} xs={3}>
                              <Row>
                                <Col
                                  ...
                                  className="ps-0"
                                >
                                  <Form.Label>Balance Amt</Form.Label>
                                </Col>
                                <Col lg={8} md={8} sm={8} xs={8}>
                                  <Form.Group>
                                    <Form.Control
