...
class TranxPurchaseOrderToInvoice extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      from_source: "tranx_purchase_order_to_invoice",
      ledgerId: "",
      setLedgerId: false,
      ledgerInputData: "",
      isTextBox: false,
  ...
  handleMstState = (rows) => {
    this.setState({ rows: rows }, () => {
      ...
      setTimeout(() => {
        document.getElementById("TPOTIProductId-particularsname-" + id).focus();
      }, 1000);
    });
  };
  ...
  callCreateInvoice = () => {
    ...
    let s_o_id = purchaseEditData.selectetPOBills.map((v) => {
      return { id: v };
    });
    requestData.append("reference_sc_id", JSON.stringify(s_o_id));
    requestData.append("reference", "PRSORD");
    ...
    createPurchaseInvoice(requestData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          eventBus.dispatch("page_change", {
            from: "tranx_purchase_order_to_invoice",
  ...
  productModalStateChange = (obj, callTrxCal = false) => {
    ...
    if (obj.isProduct == "productMdl") {
      setTimeout(() => {
        document
          .getElementById("TPOTIProductId-particularsname-" + obj.rowIndex)
          .focus();
      }, 250);
    ...
    if (obj.costingMdl == false) {
      ...
      if (document.getElementById("TPOTIAddBtn-" + id) != null) {
        setTimeout(() => {
          document.getElementById("TPOTIAddBtn-" + id).focus();
        }, 250);
      }
    }
  };
  ...
  setPurchaseInvoiceEditData = () => {
    ...
    if (purchaseEditData.selectetPOBills) {
      var purchase_order_id = purchaseEditData.selectetPOBills.map((v) => {
        return { id: v };
      });
    }
          ...
          MyNotifications.fire(
            {
              ...
              icon: "warning",
              title: "Warning",
              msg: "Challan date not valid as per Fiscal year",
              // msg: " ",
              is_button_show: false,
              is_timeout: true,
              delay: 1500,
      ...
      <div>
        <div className="purchaseinvoice">
                              ...
                              <Col lg={3} md={3} sm={3} xs={3}>
                                ...
                                >
                                  <MyTextDatePicker
                                    ...
                                    //           eventBus.dispatch(
                                    //             "page_change",
                                    //             "tranx_purchase_order_to_invoice"
                                    //           );
                                    //           // this.reloadPage();
                                    //         },
                                    //       });
                                ...
                                <Button
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode == 9) {
                                      ...
                                      document
                                        .getElementById("TPOTI_Ledger_Tab")
                                        .focus();
                                      this.setState({ currentTab: "first" });
                                    }
                                  }}
          ...
          <MdlLedger
            ...
            opType={opType} // @vinit@Passing as prop in CmpTRow
          />
          {/* Ledger Modal Ends */}
