...
class TranxPurchaseOrderToChallan extends Component {
  constructor(props) {
    super(props);
                        ...
                        MyNotifications.fire(
                          {
                            ...
                            handleSuccessFn: () => {
                              ...
                              //   this.call
                              // }
                              //! Do not call adjustment modal in challan and order
                              this.callCreateInvoice();
                            },
                            handleFailFn: () => { },
                          },
                                ...
                                <Button
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode == 9) {
                                      ...
                                      document
                                        .getElementById("TPOTC_Ledger_Tab")
                                        .focus();
                                      this.setState({ currentTab: "first" });
                                    }
                                  }}
