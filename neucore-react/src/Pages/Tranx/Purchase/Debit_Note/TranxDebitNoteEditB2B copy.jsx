...
class TranxDebitNoteEditB2B extends Component {
  constructor(props) {
    super(props);
  ...
  getProductFlavorpackageUnitbyids = () => {
    ...
    let reqData = new FormData();
    if (this.state.purchaseReturnData.id != undefined) {
      reqData.append("id", this.state.purchaseReturnData.id);
    } else {
      reqData.append("id", this.state.purchaseReturnData.returnData.id);
    }
  ...
  componentDidMount() {
    if (AuthenticationCheck()) {
      ...
      this.setState(
        { source: prop_data, purchaseReturnData: prop_data },
        () => {
                                ...
                                <MyTextDatePicker
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (e.target.value != null && e.target.value !== "") {
                                      const enteredDate = moment(e.target.value, "DD-MM-YYYY");
                                      ...
                                      if (enteredDate.isAfter(currentDate)) {
                                        ...
                                        setFieldValue("pi_invoice_dt", e.target.value);
                                        this.checkInvoiceDateIsBetweenFYFun(
                                          e.target.value,
                                          setFieldValue
                                        );
                        ...
                        let data = {
                          ...
                          invoice_data:
                            this.myRef != null && this.myRef.current
                              ? this.myRef.current.values
                              : "",
                          from_page: "tranx_debit_note_edit_B2B",
                        };
                        eventBus.dispatch("page_change", {
