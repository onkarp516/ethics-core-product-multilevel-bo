...
class TranxDebitNoteProdctCreateB2B extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isTextBox: false,
      opType: "create",
      from_source: "tranx_debit_note_product_list_B2B",
      ledgerId: "",
      ledgerType: "SC",
    ...
    getTranxDebitNoteLast()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          invoice_data["pi_no"] = res.purReturnNo;
  ...
  productModalStateChange = (obj, callTrxCal = false) => {
    ...
    if (obj.costingMdl == false) {
      ...
      if (document.getElementById("TPRCAddBtn-" + id) != null) {
        setTimeout(() => {
          document.getElementById("TPRCAddBtn-" + id).focus();
        }, 250);
      }
    }
    ...
    if (obj.isProduct == "productMdl") {
      setTimeout(() => {
        // document
        //   .getElementById("TPRCProductId-particularsname-" + obj.rowIndex)
        //   .focus();
      }, 250);
    ...
    if (obj.isBatchMdl == "batchMdl") {
      setTimeout(() => {
        // document
        //   .getElementById("TPRCProductId-batchNo-" + obj.rowIndex)
        //   .focus();
      }, 250);
    }
  };
  ...
  handleAddRow = () => {
    ...
    this.setState({ rows: rows }, () => {
      ...
      setTimeout(() => {
        document.getElementById("TPRCProductId-particularsname-" + id).focus();
      }, 1000);
    });
  };
  ...
  callCreateInvoice = () => {
    ...
    requestData.append("pur_invoice_id", selectedBillNo.id);
    ...
    create_purchase_returns_invoices(requestData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          // eventBus.dispatch("page_change", "tranx_debit_note_list");
          eventBus.dispatch("page_change", {
  ...
  handleBillsSelectionAll = (status) => {
    ...
    console.log("status", status, billLst);
    ...
    transaction_ledger_details(requestData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          this.ledgerModalStateChange("ledgerData", res.result);
        }
      })
      .catch((error) => {
        console.log("error", error);
      ...
      <>
                    ...
                    <div>
                      <Row className="mx-0 inner-div-style">
                        ...
                        >
                          ...
                          {ledgerData && ledgerData.balancingMethod == "Bill by Bill" ? (<> */}
                          <Col lg={2} md={2} sm={2} xs={2}>
                              ...
                              <Col lg={7} md={7} sm={7} xs={7}>
                                <Form.Group
                                  ...
                                  className={`${errorArrayBorder[4] == "Y"
                                    ? "border border-danger d-flex label_style px-1"
                                    : "d-flex label_style"
                                    }`}
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.key === "Tab") {
                                ...
                                <Button
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode == 9) {
                                      ...
                                      document
                                        .getElementById("TDNC_Ledger_Tab")
                                        .focus();
                                      this.setState({ currentTab: "first" });
                                    }
                                  }}
                          ...
                          <tr>
                            ...
                            >
                              <div className="d-flex mt-2">
                                ...
                                <Form.Label
                                  className="my-auto lebleclass"
                                  style={{ paddingRight: "0px !important" }}
                                >
                                  Add Charges{" "}
                                </Form.Label>
                                <Button
                                  id="TDNPC_add_charges"   //for focus on + icon  add. charges
        ...
        < MdlLedger
          ...
          transaction_ledger_detailsFun={
            this.transaction_ledger_detailsFun.bind(
              this
            )
          }
