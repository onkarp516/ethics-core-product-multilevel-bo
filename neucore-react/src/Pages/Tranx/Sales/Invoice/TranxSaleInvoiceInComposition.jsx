...
class TranxSalesInvoiceCreateInComposition extends React.Component {
  constructor(props) {
    super(props);
  ...
  callCreateInvoice = () => {
    ...
    requestData.append("client_name", invoiceValues.client_name);
    requestData.append("client_address", invoiceValues.client_address);
    requestData.append("mobile_number", invoiceValues.mobile_number);
    requestData.append(
      "gstNo",
    ...
    // debugger;
    create_sales_comp_invoices(requestData)
      .then((response) => {
        // ;
  ...
  getInvoiceBillsLstPrint = (id) => {
    ...
    getInvoiceBill(reqData).then((response) => {
      ...
      if (responseData.responseStatus == 200) {
        ...
        eventBus.dispatch("page_change", {
          from: "tranx_sales_invoice_composition_create",
  ...
  productModalStateChange = (obj, callTrxCal = false) => {
    ...
    if (obj.isBatchMdl == "batchMdl") {
      setTimeout(() => {
        document
          .getElementById("TSICProductId-batchNo-" + obj.rowIndex)
          ?.focus();
      }, 250);
    }
  };
  ...
  setledgerInputData(propValue, flag) {
    this.setState({ ledgerInputData: propValue, isTextBox: flag }, () => {
                          ...
                          <Col lg={5} md={5} sm={5} xs={5}>
                            <Row>
                              ...
                              {/* <Col
                                ...
                                className="px-0 my-auto"
                              >
                                <Form.Label>Del Type</Form.Label>
                              </Col> */}
                              {/* <Col lg={3} md={3} sm={3} xs={3}>
                                <Select
                                  className="selectTo"
...
export default connect(
  mapStateToProps,
  mapActionsToProps
)(TranxSalesInvoiceCreateInComposition);
