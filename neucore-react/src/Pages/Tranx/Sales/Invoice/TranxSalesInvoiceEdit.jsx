...
class TranxSalesInvoiceEdit extends React.Component {
  ...
  componentDidMount() {
    ...
    if (AuthenticationCheck()) {
      ...
      this.setState(
        { source: prop_data, salesEditData: prop_data.prop_data, isEdit: prop_data.edit },
        () => {
          if (this.state.salesEditData.id && prop_data.edit == true) {
