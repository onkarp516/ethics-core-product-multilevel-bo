...
class TranxSalesChallanToInvoice extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      from_source: "tranx_sales_challan_to_invoice",
      productId: "",
      setProductId: false,
  ...
  handleMstState = (rows) => {
    this.setState({ rows: rows }, () => {
      ...
      setTimeout(() => {
        document.getElementById("TSCTIProductId-particularsname-" + id).focus();
      }, 1000);
    });
  };
        ...
        () => {
          setTimeout(() => {
            ...
            if (prop_data.isProduct == "productMdl") {
              document
                .getElementById(
                  "TSCTIProductId-particularsname-" + prop_data.rowIndex
                )
                .focus();
  ...
  getSalesQuotationProductFpuByIds = () => {
    ...
    let s_c_ids = salesEditData.selectedBills.map((v) => {
      return { id: v };
    });
  ...
  setSalesQuotationEditData = () => {
    ...
    let reqData = new FormData();
    //console.log("salesEditData=-> ", salesEditData);
    let sales_challan_ids = salesEditData.selectedBills.map((v) => {
      return { id: v };
    });
  ...
  callCreateInvoice = () => {
    ...
    requestData.append("reference", "SLSCHN");
  ...
  productModalStateChange = (obj, callTrxCal = false) => {
    ...
    if (obj.isProduct == "productMdl") {
      setTimeout(() => {
        document
          .getElementById("TSCTIProductId-particularsname-" + obj.rowIndex)
          .focus();
      }, 250);
  ...
  getProductBatchList = (rowIndex, source = "batch") => {
    ...
    // if (document.getElementById("TSCTIAddBtn-" + id) != null) {
    //   setTimeout(() => {
    //     document.getElementById("TSCTIAddBtn-" + id).focus();
    //   });
    // }
  };
                      ...
                      if (
                        ...
                        if (values.mode == "multi") {
                          this.setState(
                            ...
                            () => {
                              setTimeout(() => {
                                document.getElementById("amount-0").focus();
                              }, 500);
                            }
                          );
                        } else
                          MyNotifications.fire(
                            {
                              ...
                              handleSuccessFn: () => {
                                ...
                                //console.log("supplierCodeId", values);
                              },
                              handleFailFn: () => {},
                            },
                            () => {
              ...
              >
                <>
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.shiftKey && e.keyCode === 9) {
                                      ...
                                      if (
                                        ...
                                        document
                                          .getElementById(
                                            "TSCTIProductId-particularsname-0"
                                          )
                                          .focus();
                  ...
                  <CmpTRow
                    ...
                    qtyData={qtyData}
                    rateData={rateData}
                    productId="TSCTIProductId-"
                    addBtnId="TSCTIAddBtn-"
