...
class TranxSalesQuotationToOrder extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      qtyData: "",
      rateData: "",
      from_source: "tranx_sales_quotation_to_order",
      productId: "",
      setProductId: false,
    ...
    getSundryDebtors()
      .then((response) => {
        ...
        if (res.responseStatus === 200) {
          ...
          //console.log("suppliernamelist", opt, codeopt);
          this.setState({
            supplierNameLst: opt,
  ...
  handleMstState = (rows) => {
    this.setState({ rows: rows }, () => {
      ...
      setTimeout(() => {
        document.getElementById("TSQTOProductId-particularsname-" + id).focus();
      }, 1000);
    });
  };
  ...
  //   if (document.getElementById("TSQTOAddBtn-" + id) != null) {
  //     setTimeout(() => {
  //       document.getElementById("TSQTOAddBtn-" + id).focus();
  //     });
  //   }
  // };
  ...
  productModalStateChange = (obj, callTrxCal = false) => {
    ...
    if (obj.isProduct == "productMdl") {
      setTimeout(() => {
        document
          .getElementById("TSQTOProductId-particularsname-" + obj.rowIndex)
          .focus();
      }, 250);
  ...
  handleFetchData = (sundry_creditor_id) => {
    //console.log("handleFetchData:", sundry_creditor_id);
    let reqData = new FormData();
    ...
    createSalesOrder(requestData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          eventBus.dispatch("page_change", {
            from: "tranx_sales_quotation_to_order",
        ...
        () => {
          setTimeout(() => {
            ...
            if (prop_data.isProduct == "productMdl") {
              document
                .getElementById(
                  "TSQTOProductId-particularsname-" + prop_data.rowIndex
                )
                .focus();
  ...
  componentDidMount() {
    if (AuthenticationCheck()) {
      ...
      this.setState({ salesEditData: prop_data }, () => {
        // console.log("salesEditData--", this.state.salesEditData);
  ...
  getSalesQuotationProductFpuByIds = () => {
    ...
    let reqData = new FormData();
    // console.log("salesEditData=-> v", salesEditData);
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          let initInvoiceData = {
            ...
            //so_bill_no: invoice_data.sales_quotation_no,
            so_bill_no: this.state.invoice_data.so_bill_no,
          ...
          //console.log("invoice_data", invoice_data);
          //console.log("initRowDate -> s ", initRowData);
          this.setState(
            {
          ...
          MyNotifications.fire(
            {
              ...
              icon: "warning",
              title: "Warning",
              msg: "Order date not valid as per Fiscal year",
              // msg: " ",
              is_button_show: false,
              is_timeout: true,
              delay: 1500,
                        ...
                        MyNotifications.fire(
                          {
                            ...
                            handleSuccessFn: () => {
                              ...
                              //console.log("handleSuccessFn", values);
                              if (selectedSupplier) {
              ...
              >
                <>
                            ...
                            <Row>
                              ...
                              <Col lg={8} md={8} sm={8} xs={8}>
                                ...
                                <Form.Control
                                  ...
                                  //     // document.getElementById('supplierCodeId').focus()
                                  //   }
                                  // }}
                                  // value={
                              ...
                              <Col lg={4} md={4} sm={4} xs={4}>
                                ...
                                >
                                  <MyTextDatePicker
                                    ...
                                    //           eventBus.dispatch(
                                    //             "page_change",
                                    //             "tranx_sales_quotation_to_order"
                                    //           );
                                    //           // this.reloadPage();
                                    //         },
                                    //       });
                  ...
                  <CmpTRow
                    ...
                    rateData={rateData}
                    productId="TSQTOProductId-"
                    addBtnId="TSQTOAddBtn-"
                  ...
                  {/* <Table className="btm-description-style mx-0">
                    <thead>
                      <th className="table-width">
                        <td>
                          <span className="span-lable">HSN:</span>
                        </td>
                        <td>
