        ...
        >
                  ...
                  <div className="counter_sale_tbl">
                    <Table className="">
                      ...
                      <tbody>
                        ...
                        // }}
                        >
                          <td className="sr-no-style">1234567890</td>
                          <td
                        ...
                        <td>
                          ...
                          <td className="d-flex">
                            ...
                            // }}
                            >
                              <img src={print} alt="" className="btnimg" />
                            </Button>
                            <Button
                              // id={this.props.addBtnId + ri}
                              className="btn_style"
                              ...
                              return (
                                <tr
                                  onClick={(e) => {
                                    ...
                                    this.setState({ code_name: v.name });
                                  }}
                                >
                                  <td>{v.no}</td>
                                  <td>{v.name}</td>
                            ...
                            {cust_data.map((v) => {
                              return (
                                ...
                                >
                                  ...
                                  <td>{/* {v.expiry_date} */}</td>
                                  <td>
                                    {/* {isNaN(v.mrp)                              ? INRformat.format(0)                              : INRformat.format(v.mrp)} */}
                                  </td>
                                  <td>
                                    {/* {isNaN(v.opening_stock)                              ? INRformat.format(0)                              : INRformat.format(v.opening_stock)} */}
                                  </td>
                                  <td>
                                    {/* {isNaN(v.closing_stock)                              ? INRformat.format(0)                              : INRformat.format(v.closing_stock)} */}
                                  </td>
                                  <td>
                                    {/* {isNaN(v.purchase_rate)                              ? INRformat.format(0)                              : INRformat.format(v.purchase_rate)} */}
                                  </td>
                                  <td>
                                    {/* {isNaN(v.costing)                              ? INRformat.format(0)                              : INRformat.format(v.costing)} */}
                                  </td>
                                  <td>
                                    {/* {isNaN(v.costingWithTax)                              ? INRformat.format(0)                              : INRformat.format(v.costingWithTax)} */}
                                  </td>
                                  <td>
                                    {/* {isNaN(v.min_rate_a)                              ? INRformat.format(0)                              : INRformat.format(v.min_rate_a)} */}
                                  </td>
                                  <td className="text-center">
                                    <Button className="btn_style">
                                      <img
                  ...
                  <Row className="">
                    <Col lg={12} md={12} sm={12} xs={12}>
                      <Row className="counter_sale_btm_part mx-0 px-2">
                        <Col lg="3" md="3" sm={3} xs="3" className="paddingtop">
                          <Row>
                            <Col
                              lg={3}
                              md={3}
          ...
          >
            ...
            <Modal.Body className="tnx-pur-inv-mdl-body p-0">
              ...
              <Button
                className="create-btn float-end my-2"
                type="submit"
