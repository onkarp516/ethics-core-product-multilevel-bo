...
class TranxSalesInvoiceEdit extends React.Component {
          ...
          MyNotifications.fire(
            {
              ...
              handleFailFn: () => {
                ...
                if ("ledgerId" in this.state.source != "") {
                  eventBus.dispatch("page_change", {
                    from: "tranx_countersale_to_saleinvoice",
                    to: "ledgerdetails",
                    // prop_data: {
    ...
    get_counter_sales_by_no(reqData)
      .then((response) => {
        ...
        if (res.responseStatus === 200) {
          ...
          console.log("res.paymentMode", res.paymentMode);
  ...
  handleMstState = (rows) => {
    this.setState({ rows: rows }, () => {
      ...
      setTimeout(() => {
        document.getElementById("TSIEProductId-" + id).focus();
      }, 1000);
    });
  };
  ...
  productModalStateChange = (obj, callTrxCal = false) => {
    ...
    if (obj.isProduct == "productMdl") {
      setTimeout(() => {
        document.getElementById("TSIEProductId-" + obj.rowIndex).focus();
      }, 250);
    ...
    if (obj.isBatchMdl == "batchMdl") {
      setTimeout(() => {
        document
          .getElementById("TSIEProductId-batchNo-" + obj.rowIndex)
          .focus();
      }, 250);
    }
  };
    ...
    return (
      <>
        ...
        <div className="purchase-tranx" style={{ overflow: "hidden" }}>
                  ...
                  <Row className="mx-0 btm-data">
                    ...
                    >
                      <Tab.Container
                        ...
                        // @prathmesh @batch info & product info tab active start
                        // activeKey={
                        //   ledgerModal === true || isFocused === true ? "first" : productData !== "" ? "second" : "second"
                        // }
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td className="py-0">
                              ...
                              {/* @mrunal @Tcs Tds Radio button true false  */}
                              <Row>
                                <Col lg="12">
                                  <Form.Group
                                    style={{ width: "fit-content" }}
          ...
          {/* Ledger Modal Starts */}
          <MdlLedger
            ref={this.customModalRef} //@mrunal @on click outside modal will close
