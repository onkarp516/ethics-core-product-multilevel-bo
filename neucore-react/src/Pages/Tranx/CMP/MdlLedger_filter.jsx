...
export default class MdlLedger extends Component {
  ...
  handleLstChange = () => {
    let { orgLedgerList, ledgerType } = this.state;
    // debugger;
    if (orgLedgerList.length > 0) {
      // const selectedAll = ledgerType;
      let filterLst = [];
      if (ledgerType !== "")
        filterLst = orgLedgerList.filter((v) => v.type === ledgerType);
      ...
      // }
      this.setState({
        ledgerList: filterLst.length > 0 ? filterLst : orgLedgerList,
      });
    }
  };
  ...
  componentDidMount() {
    console.log("mdlledger >>>", this.props);
  ...
  render() {
    let { ledgerList, ledgerType } = this.state;
                    ...
                    <Form.Group className="">
                      <Form.Select
                        ...
                        onChange={(e) => {
                          ...
                          this.setState({ ledgerType: e.target.value }, () => {
                            this.handleLstChange();
                          });
                        }}
                        value={ledgerType}
