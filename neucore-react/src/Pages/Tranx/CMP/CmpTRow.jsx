...
class CmpTRow extends Component {
  ...
  componentWillReceiveProps(prev, next) {
    ...
    // if (orgLstProductRows != "" && rows[this.props.rowIndex] && rows[this.props.rowIndex]["product_id"] != "" && transactionType == "credit_note") {
    //   this.handleBillSelectionProduct(this.props.rowIndex);
    // }
  }
  // handleBillSelectionProduct = (rowIndex) => {
  //   // debugger;
  //   let { rows, productModalStateChange, orgLstProductRows } = this.props;

  //   let p_id = rows[rowIndex]["productId"];
  //   let selectedProduct;
  //   if (p_id && p_id != "") {
  //     selectedProduct = orgLstProductRows.find(
  //       (vi) => parseInt(vi.product_id) === parseInt(p_id)
  //     );
  ...
  //         icon: "error",
  //         title: "Error",
  //         msg: "This product is not available in bill",
  //         is_button_show: true,
  //       });
  //     }
  //   }
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          this.setState(
            ...
            () => {
              // productBatchTr_0
              getProductBatchList(rowIndex, "batch", true, b_details_id);
            }
          );
        } else {
          MyNotifications.fire({
  ...
  setBatchInputData(propValue, flag, id) {
    this.setState(
      ...
      () => {
        if (propValue && propValue != "" && document.getElementById(id)) {
          document.getElementById(id).value = propValue;
        }
      }
    );
  ...
  handleProductTableRow(event) {
    ...
    if (k === 40) {
      ...
      if (
        ...
        let productLstIds = orgLstProductRows.map((v) => {
          return parseInt(v.product_id);
        });
        let p_id = parseInt(selectedProduct.id);
        // if (
        //   prevProduct &&
        //   prevProduct.product_id &&
        //   selectedProduct &&
        //   parseInt(selectedProduct["id"]) !== parseInt(prevProduct.product_id)
        //   // parseInt(rows[rowIndex]["selectedProduct"]["id"])
        // ) {
        if (productLstIds.includes(p_id) && selectedProduct) {
          if (
            ...
            setTimeout(() => {
              // if (
              //   selectedProduct.is_batch == true &&
              //   selectedProduct.is_serial == true
              // ) {
              document
                .getElementById(productId + "batchNo-" + rowIndex)
                .focus();
              // } else {
            ...
            /**
             * @description Check if the selected product is different then only clear other records
             */
            if (
              ...
              rows = this.ClearRowValues(rows, rowIndex);
            }
            rows[rowIndex]["selectedProduct"] = selectedProduct;
  ...
  handleBatchTableRow(event) {
    ...
    if (k === 40) {
      ...
      if (NoOfDays < 0) {
        ...
        if (selectedBatch != 0) {
          console.warn("selectedBatch ", selectedBatch);
          batchError = false;
          let salesrate = selectedBatch.min_rate_a;
          ...
          if (
            ...
            rows[rowIndex]["rate"] =
              rows[rowIndex]["rate"] == "" ? salesrate : rows[rowIndex]["rate"];
            rows[rowIndex]["sales_rate"] = salesrate;
          } else {
            rows[rowIndex]["rate"] =
              rows[rowIndex]["rate"] == ""
                      ...
                      >
                        ...
                        >
                          <Form.Control
                            ...
                            onClick={(e) => {
                              ...
                              console.warn("opType <<<<<<<<< ", opType);
                              if (opType === "edit") {
                                this.setState({ prevProduct: rows[ri] });
                              }
                              ...
                              this.setState(
                                ...
                                () => {
                                  if (rv.productId != "") {
                                    ...
                                    if (index >= 0) {
                                      document
                                        .getElementById("productMdlTr_" + index)
                                        .focus();
                                    }
                                  }
                                }
                        ...
                        <td>
                          <Form.Group
                            ...
                            onKeyDown={(e) => {
                              if (e.keyCode == 13) {
                                this.focusNextElement(productTrForm, e.target);
                              }
                            }}
                          >
                            <Select
                        ...
                        <td>
                          <Form.Control
                            ...
                            value={rows[ri]["qty"] === 0 ? "" : rows[ri]["qty"]}
                            onKeyPress={(e) => {
                              OnlyEnterNumbers(e);
                            }}
                            onKeyDown={(e) => {
                                  ...
                                  if (e.target.value == "") {
                                    ...
                                    if (
                                      ...
                                      MyNotifications.fire({
                                        ...
                                        title: "Warning",
                                        msg:
                                          "Purchase Rate is Less Than Given rate, Do You want To Continue?",
                                        is_button_show: true,
                                        delay: 10,
                                        handleSuccessFn: () => {
                                          setTimeout(() => {
                        ...
                        <td>
                          <Form.Control
                            ...
                            type="text"
                            placeholder="0"
                            value={rows[ri]["gst"] == 0 ? "" : rows[ri]["gst"]}
                            disabled
                            readOnly
                          />
                        </td>
                        ...
                        <tr
                          ...
                          onDoubleClick={(e) => {
                            ...
                            if (
                              ...
                              if (
                                productLstIds.includes(p_id) &&
                                selectedProduct
                              ) {
                                let returnselectedProduct = orgLstProductRows.find(
                                  (v) => parseInt(v.product_id) == p_id
                                );
                                console.log(
                                ...
                                rows[rowIndex]["b_no"] =
                                  returnselectedProduct.batch_no;
                                rows[rowIndex]["b_rate"] =
                                  returnselectedProduct.b_rate;
                                rows[rowIndex]["rate_a"] = "";
                                rows[rowIndex]["rate_b"] = "";
                                rows[rowIndex]["rate_c"] = "";
                                rows[rowIndex]["rate"] =
                                  rows[rowIndex]["rate"] == ""
                                    ? returnselectedProduct.rate
                                    : rows[rowIndex]["rate"];
                                rows[rowIndex]["gross_amt"] =
                                  returnselectedProduct.gross_amt;
                                rows[rowIndex]["gross_amt1"] =
                                  returnselectedProduct.gross_amt1;
                                rows[rowIndex]["disc_amt"] = "";
                                rows[rowIndex]["disc_per"] = "";
                                rows[rowIndex]["disc_per2"] = "";
                                rows[rowIndex]["base_amt"] = "";
                                ...
                                rows[rowIndex]["total_base_amt"] = "";
                                rows[rowIndex]["base_amt"] =
                                  returnselectedProduct.total_amt;
                                rows[rowIndex]["total_amt"] = "";
                                rows[rowIndex]["qty"] =
                                  returnselectedProduct.qty;
                                rows[rowIndex]["dis_amt"] = "";
                                rows[rowIndex]["dis_per"] = "";
                                rows[rowIndex]["dis_per2"] = "";
                                rows[rowIndex]["row_dis_amt"] = "";
                                rows[rowIndex]["invoice_dis_amt"] = "";
                                rows[rowIndex]["gst"] =
                                  returnselectedProduct.gst;
                                rows[rowIndex]["igst"] =
                                  returnselectedProduct.total_igst;
                                rows[rowIndex]["cgst"] =
                                  returnselectedProduct.total_cgst;
                                rows[rowIndex]["sgst"] =
                                  returnselectedProduct.total_sgst;
                                rows[rowIndex]["final_amt"] =
                                  returnselectedProduct.final_amt;
                                rows[rowIndex]["costing"] = "";
                                rows[rowIndex]["costing_with_tax"] = "";
                                ...
                                setTimeout(() => {
                                  document
                                    .getElementById(
                                      productId + "particularsname-" + rowIndex
                                    )
                                    .focus();
                                  // alert("hiiiiiiii");
                                }, 2000);
                              ...
                              if (selectedProduct) {
                                if (
                                  ...
                                  if (
                                    parseInt(selectedProduct.id) !==
                                    parseInt(
                                      rows[rowIndex]["selectedProduct"]["id"]
                                    )
                                  ) {
                                    rows = this.ClearRowValues(rows, rowIndex);
                                  }
                    ...
                    <h6 className="table-header-batch my-auto">
                      ...
                      <Badge bg="secondary" className="ms-2">
                        {batchDataList &&
                          ...
                          batchDataList.reduce(
                            (prev, next) =>
                              parseFloat(prev) + parseFloat(next.closing_stock),
                            0
                          )}
                      </Badge>
                    </h6>
                    ...
                    <Form
                      ...
                      onKeyDown={(e) => {
                        if (e.keyCode === 13) {
                          ...
                          if (isBatch == true)
                            document
                              .getElementById("productBatchTr_0")
                              ?.focus();
                        }
                      }}
                    >
                      ...
                      >
                        <Row className="">
                                  ...
                                  <Form.Control
                                    ...
                                    onChange={(e) => {
                                      if (
                                        ...
                                        this.batchSearchFun(e.target.value);
                                        setFieldValue("b_no", e.target.value);
                                      } else {
                                        setFieldValue("b_no", e.target.value);
                                      }
                                    }}
                          ...
                          {saleRateType !== "sale" ||
                          (rows[rowIndex]["selectedProduct"] &&
                            rows[rowIndex]["selectedProduct"]["is_negative"] ===
                              true) ? (
                            <Col lg={9}>
                              <Row>
                                <Col lg={4}>
                                              ...
                                              if (
                                                ...
                                                if (
                                                  ...
                                                  MyNotifications.fire({
                                                    ...
                                                    title: "Error",
                                                    msg:
                                                      "Expiry date should be greater MFG date / Current Date",
                                                    // is_button_show: true,
                                                    is_timeout: true,
                                                    delay: 1500,
                                                  });
                                                ...
                                                if (curdatetime < curdatet) {
                                                  ...
                                                  MyNotifications.fire({
                                                    ...
                                                    title: "Error",
                                                    msg:
                                                      "Expiry date should be greater current date",
                                                    // is_button_show: true,
                                                    is_timeout: true,
                                                    delay: 1500,
                                                  });
                    ...
                    {batchDataList &&
                      ...
                      batchDataList.map((v, i) => {
                        return ismodify == true && modifyIndex == i ? (
                          <tr tabIndex={0} id={`productBatchTr_` + i}>
                            <td
                              className="p-0"
                              style={{
                            ...
                            onDoubleClick={(e) => {
                              ...
                              if (NoOfDays < 0) {
                                ...
                                if (b_details_id != 0) {
                                  batchError = false;
                                  let salesrate = b_details_id.min_rate_a;
                                  // let { orgLstProductRows } = this.props;
                                  console.log(
                                    "b_details_id",
                                  ...
                                  if (transactionType == "credit_note") {
                                    ...
                                    let productBatchExist = orgLstProductRows.find(
                                      (v) =>
                                        parseInt(v["product_id"]) ==
                                        parseInt(rows[rowIndex]["productId"])
                                    );
                                    console.log("product", productBatchExist);
                                    console.log(
                                      "b_details_id",
                                      rows[rowIndex]["b_details_id"]
                                    );
                                    if (
                                      productBatchExist &&
                                      parseInt(b_details_id.id) ==
                                        parseInt(productBatchExist.b_detailsId)
                                    ) {
                                      rows[rowIndex]["b_details_id"] =
                                        b_details_id.id;
                                      rows[rowIndex]["b_no"] =
                                      ...
                                      MyNotifications.fire({
                                        ...
                                        title: "Error",
                                        msg:
                                          "This batch is not available in bill",
                                        is_button_show: true,
                                      });
                                      rows[rowIndex]["b_details_id"] = "";
                                      rows[rowIndex]["b_no"] = "";
