...
export default class VoucherDebitEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      from_source: "voucher_debit_note_edit",
      opType: "edit",
      isPropDataSet: false,
      selectedAll: true,
      isChecked: true,
      ...
      if (res.responseStatus == 200) {
        ...
        let Opt = d.map((v, i) => {
          ...
          if (v.subprinciple_name != "") {
            ...
            innerOpt["type"] = v.type;
            innerOpt["balancingMethod"] = v.balancing_method;
  ...
  handleChangeArrayElement = (element, value, index) => {
    ...
    if (element == "perticulars") {
      ...
      if (obj && obj.type == "dr") {
        ...
        if (obj && obj.perticulars.type == "others") {
              ...
              setTimeout(() => {
                if (prop_data.prop_data != "") {
                  this.FocusTrRowFieldsID(
                    `debitnoteEdt-perticulars-${this.props.block.prop_data.prop_data.rowIndex}`
                  );
                } else {
                }
              }, 1000);
  ...
  componentDidMount() {
    if (AuthenticationCheck()) {
      ...
      this.setState(
        {
          debitNoteEditData: prop_data.prop_data,
          prop_data: prop_data,
          isPropDataSet: true,
        },
        () => {
  ...
  handleVoucherDebitNoteLedgerTableRow(event) {
    // console.log("handleVoucherDebitNoteLedgerTableRow", event);
    ...
    if (k == 13) {
              ...
              this.setState(
                ...
                () => {
                  ...
                  if (currentR && currentR["type"] == "cr") {
                    this.FocusTrRowFieldsID(`debitnoteEdt-credit-${rowIndex}`);
                  } else if (currentR && currentR["type"] == "dr") {
                    this.FocusTrRowFieldsID(`debitnoteEdt-debit-${rowIndex}`);
                  }
                }
              );
              this.FocusTrRowFieldsID(`debitnoteEdt-credit-${rowIndex}`);
      ...
      if (selectedLedgerIndex < ledgerList.length - 1) {
        this.setState({ selectedLedgerIndex: selectedLedgerIndex + 1 }, () => {
          this.FocusTrRowFieldsID(
            `debitnote-edt-ledger-${this.state.selectedLedgerIndex}`
          );
        });
      }
    } else if (k == 38) {
    ...
    this.setState(
      ...
      () => {
        ...
        this.setState(
          ...
          () => {
            console.log("row innerrow====", this.state.rows);
            this.FocusTrRowFieldsID(`debitnoteEdt-perticulars-${index + 1}`);
          }
        );
      }
    );
              ...
              this.setState(
                {
                  ...
                  debitUncheckData: debitUncheckData,
                  openingUncheckData: openingUncheckData,
                  isDebitExist: debitLst.length > 0 ? true : false,
    ...
    rows.map((v, i) => {
      if (debitAmt != creditAmt) {
        ...
        this.setState(
          ...
          () => {
            this.FocusTrRowFieldsID(`debitnote-perticulars-${index + 1}`);
          }
        );
        // }
      }
                    ...
                    MyNotifications.fire(
                      {
                        ...
                        handleSuccessFn: () => {
                          ...
                          formData.append("id", values.voucher_debit_sr_no);
                            ...
                            .then((response) => {
                              ...
                              if (res.responseStatus == 200) {
                                ...
                                eventBus.dispatch("page_change", {
                                  ...
                                  isCancel: true,
                                  prop_data: {
                                    editId: this.state.debitNoteEditData.id,
                  ...
                  <Col md="12">
                    ...
                    >
                      <div className="" style={{ height: "auto" }}>
                                    ...
                                    <tr className="entryrow">
                                      <td style={{ width: "5%" }}>
                                        ...
                                        <Form.Group>
                                          <Select
                                            ...
                                            name={`debitnoteEdt-type-${ii}`}
                                            id={`debitnoteEdt-type-${ii}`}
                                            value={this.setElementValue(
                                              "typeobj",
                                              ii
                                            )}
                                      ...
                                      >
                                        ...
                                        <Form.Control
                                          ...
                                          placeholder=" "
                                          name={`debitnoteEdt-perticulars-${ii}`}
                                          id={`debitnoteEdt-perticulars-${ii}`}
                                          onChange={(e) => {
                                            e.preventDefault();
                                          ...
                                          onKeyDown={(e) => {
                                            if (e.keyCode == 13) {
                                              ...
                                              if (ledgerModal == true) {
                                                document
                                                  .getElementById(
                                                    "debitnote-edt-ledger-0"
                                                  )
                                                  ?.focus();
                                                document
                                                  .getElementById(
                                                    "debitnote-edt-ledger-cashac-0"
                                                  )
                                                  ?.focus();
                                              } else {
                                      ...
                                      <td style={{ width: "10%" }}>
                                        <Form.Control
                                          ...
                                          name={`debitnoteEdt-debit-${ii}`}
                                          id={`debitnoteEdt-debit-${ii}`}
                                          onBlur={(e) => {
                                            e.preventDefault();
                                            let v = e.target.value;
                                            this.setState(
                                          ...
                                          //   let currentR = rows[ii];
                                          //   let innerrow = "";

                                          //   if (currentR && currentR["type"] == "cr") {
                                          //     innerrow = {
                                          //       type: "cr",
                                          //       typeobj: getSelectValue(
                                          //         selectOpt,
                                          //         "cr"
                                          //       ),
                                          //       perticulars: "",
                                      ...
                                      <td style={{ width: "10%" }}>
                                        <Form.Control
                                          ...
                                          name={`debitnoteEdt-credit-${ii}`}
                                          id={`debitnoteEdt-credit-${ii}`}
                                          style={{ textAlign: "center" }}
                                          value={this.setElementValue(
                                            "credit",
                                            ii
                                  ...
                                  MyNotifications.fire(
                                    {
                                      ...
                                      handleSuccessFn: () => {
                                        eventBus.dispatch("page_change", {
                                          ...
                                          prop_data: {
                                            editId:
                                              this.state.debitNoteEditData.id,
                                            rowId:
                        ...
                        <Row className="btm-rows-btn1 mx-0">
              ...
              <div className="ledger-table">
                <Table
                  ...
                  onKeyDown={(e) => {
                    e.preventDefault();
                    if (e.keyCode != 9) {
                      this.handleVoucherDebitNoteLedgerTableRow(e);
                    }
                  }}
                >
                  <thead>
                          ...
                          <Col lg={6} className="text-end">
                            <Button
                              ...
                              onKeyDown={(e) => {
                                if (e.keyCode === 40) {
                                  document
                                    .getElementById("debitnote-edt-ledger-0")
                                    .focus();
                                } else if (e.keyCode === 13) {
                                  if (
                                    isActionExist(
                    ...
                    {ledgerList.map((v, i) => {
                      return (
                        <tr
                          ...
                          id={`debitnote-edt-ledger-${i}`}
                          // prId={v.id}
                          tabIndex={i}
                          className={`${
                            i == selectedLedgerIndex
                              ? "debitnote-edt-ledger-selected-tr"
                              : ""
                          }`}
                          onDoubleClick={(e) => {
                            e.preventDefault();
                            ...
                            if (v.balancingMethod != "on-account") {
                              ...
                              if (currentR && currentR["type"] == "cr") {
                                this.FocusTrRowFieldsID(
                                  `debitnoteEdt-credit-${rowIndex}`
                                );
                              } else if (currentR && currentR["type"] == "dr") {
                                this.FocusTrRowFieldsID(
                                  `debitnoteEdt-debit-${rowIndex}`
                                );
                              }
                            } else {
                              this.setState(
