...
export default class VoucherDebitNote extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      billLst: [],
      opType: "create",
      from_source: "voucher_debit_note",
              ...
              setTimeout(() => {
                if (prop_data != "") {
                  this.FocusTrRowFieldsID(
                    `debitnote-perticulars-${this.props.block.prop_data.rowIndex}`
                  );
                } else {
                }
              }, 1000);
      ...
      if (obj) {
        this.setState(
          ...
          () => {
            ...
            if (obj.balancingMethod && obj.balancingMethod == "bill-by-bill") {
              ...
              this.setState(
                ...
                () => {
                  ...
                  if (currentR && currentR["type"] == "cr") {
                    this.FocusTrRowFieldsID(`debitnote-credit-${rowIndex}`);
                  } else if (currentR && currentR["type"] == "dr") {
                    this.FocusTrRowFieldsID(`debitnote-debit-${rowIndex}`);
                  }
                }
              );
              this.FocusTrRowFieldsID(`debitnote-credit-${rowIndex}`);
  ...
  handleBillByBill = (element, value, index) => {
    ...
    if (element == "debit") {
      ...
      console.log("obj in handle", obj);

      if (obj && obj.type == "dr" && selectedLedger) {
        this.FetchPendingBills(
          selectedLedger.id,
          selectedLedger.type,
          ...
          >
            {({
              ...
              >
                    ...
                    <Row>
                      ...
                      <Col md="2">
                        <Form.Control
                          ...
                          isValid={
                            touched.voucher_debit_sr_no &&
                            !errors.voucher_debit_sr_no
                          }
                          isInvalid={!!errors.voucher_debit_sr_no}
                          readOnly={true}
                          ...
                          onKeyDown={(e) => {
                            ...
                            if (e.shiftKey && e.key === "Tab") {
                              ...
                              if (
                                ...
                                this.FocusTrRowFieldsID(`debitnote-perticulars-0`);
                                // alert("hey!!!");
                              }
                            }
                          }}
                            ...
                            <tr className="entryrow">
                              <td style={{ width: "5%" }}>
                                ...
                                <Form.Group>
                                  <Select
                                    ...
                                    // name="type"
                                    // id="type"
                                    name={`debitnote-type-${ii}`}
                                    id={`debitnote-type-${ii}`}
                                    // value={values.type}
                              ...
                              >
                                ...
                                <Form.Control
                                  ...
                                  placeholder=" "
                                  name={`debitnote-perticulars-${ii}`}
                                  id={`debitnote-perticulars-${ii}`}
                                  onChange={(e) => {
                                    e.preventDefault();
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.keyCode == 13) {
                                      ...
                                      setTimeout(() => {
                                        document
                                          .getElementById("VDNC-addProduct-create")
                                          .focus();
                                      }, 1000);
                              ...
                              <td style={{ width: "10%" }}>
                                <Form.Control
                                  name={`debitnote-debit-${ii}`}
                                  id={`debitnote-debit-${ii}`}
                                  type="text"
                              ...
                              <td style={{ width: "10%" }}>
                                <Form.Control
                                  name={`debitnote-credit-${ii}`}
                                  id={`debitnote-credit-${ii}`}
                                  type="text"
                                  className="table-text-box border-0"
                                  onChange={(e) => {
                                    let v = e.target.value;
                ...
                <thead style={{ borderTop: "2px solid transparent" }} className="account_btm_part">
                  ...
                  <Row>
                    <Col lg="8">
                      <Row className="accountentry-description-style">
                        ...
                        <Col lg={3} style={{ borderRight: "1px solid #EAD8B1" }}>
                          <div className="d-flex">
                      ...
                      <Row className="mt-2">
                        ...
                        <Col sm={11}>
                          <Form.Control
                            ...
                            onKeyDown={(e) => {
                              if (e.keyCode == 13) {
                                this.handleKeyDown(e, "VDNC_submit_btn");
                              }
                            }}
                          />
                        </Col>
                      ...
                      return (
                        <tr
                          ...
                          onDoubleClick={(e) => {
                            ...
                            this.setState({ ledgerModal: false, selectedLedgerIndex: 0, selectedLedger: v });
                            this.transaction_ledger_listFun();
                          }}
        ...
        >
          ...
          <Modal.Body className="purchaseumodal p-invoice-modal pt-0">
            ...
            <Form noValidate className="pt-0">
              <Row style={{ backgroundColor: "#E6f2f8", padding: "5px" }} className="mb-2">
                <Col lg={3}>
                  <Row>
                    <Col lg={5}>
