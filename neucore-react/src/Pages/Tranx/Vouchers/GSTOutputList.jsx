...
class GSTOutputList extends React.Component {
  constructor(props) {
    super(props);
  ...
  deletegstinput = (id) => {
    ...
    handleSearch = (vi) => {
      let { gstInputList } = this.state;
      console.log({ gstInputList });
      let orgData_F = gstInputList.filter(
        (v) =>
