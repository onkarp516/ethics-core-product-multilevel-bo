...
export default class ReceiptEdit extends React.Component {
  ...
  FetchPendingBills = (id, type, balancingMethod, value) => {
    console.log("balancingMethod ", balancingMethod, type);
    ...
    getdebtorspendingbills(reqData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          if (data.length > 0) {
            if (balancingMethod === "bill-by-bill" && type === "SD") {
            ...
            } else if (balancingMethod === "bill-by-bill" && type === "SC") {
              this.setState({
                billLstSc: data,
            ...
            } else if (balancingMethod === "on-account") {
              this.setState({
                billLst: data,
                onaccountmodal: false,
                selectedBills: [],
