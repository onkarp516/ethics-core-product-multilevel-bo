...
export default class VoucherCreditEdit extends React.Component {
  ...
  componentDidMount() {
    if (AuthenticationCheck()) {
      ...
      this.setState({ creditNoteEditData: prop_data });
      // mousetrap.bindGlobal("esc", this.PreviuosPageProfit);
    }
  }
  componentDidUpdate() {
    const { isEditDataSet, creditNoteEditData, ledgersLst } = this.state;
                ...
                MyNotifications.fire(
                  {
                    ...
                    handleSuccessFn: () => {
                      ...
                      formData.append("credit_id", values.voucher_credit_sr_no);
