...
export default class GSTOutput extends Component {
  constructor(props) {
    super(props);
      ...
      .then((response) => {
        ...
        if (res.responseStatus === 200) {
          ...
          this.setState({ optHSNList: options }, () => {
            if (id != "") {
              let optSelected = getSelectValue(options, parseInt(id));
  ...
  handleGstChange = (value, element, valObject, setFieldValue) => {
    ...
    if (valObject.sratio != "") {
      ...
      setFieldValue("sratio", sratio > 0 ? sratio : "");
      setFieldValue("cgst", per > 0 ? per : "");
      setFieldValue("sgst", rem > 0 ? rem : "");
      // } else {
  ...
  handleTranxCalculation = () => {
    ...
    this.myRef.current.setFieldValue("taxCalculation", taxState);
                  ...
                  <Row>
                    ...
                    <Col md={1} lg={2} sm={1}>
                      <Form.Control
                        ...
                        className="mb-0 mt-1 tnx-pur-inv-date-style"
                      ...
                      return (
                        <tr
                          onDoubleClick={(e) => {
                            ...
                            this.setState(
                              { selectedLedger: v, partyNameId: v.id },
                              () => {
