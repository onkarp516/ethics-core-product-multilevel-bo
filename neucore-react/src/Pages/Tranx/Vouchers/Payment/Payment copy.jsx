        ...
        <div className="cust_table">
          <Formik
            ...
            onSubmit={(values, { setSubmitting, resetForm }) => {
              ...
              let errorArray = [];
              if (values.transaction_dt == "" || values.transaction_dt == "__/__/____") {
                errorArray.push("Y");
              } else {
                errorArray.push("");
              }
                    ...
                    MyNotifications.fire(
                      {
                        ...
                        handleSuccessFn: () => {
                          ...
                          // console.log('rows', rows);
                          formData.append("transaction_dt", moment(values.pi_transaction_dt, "DD/MM/YYYY").format("YYYY-MM-DD"));
                          ...
                          <thead>
                            <tr>
                              <th className="">
                                ...
                                <span className="pt-2 mt-2" style={{ verticalAlign: "middle" }}>
                                  {" "}
                                  Credit Note #.
                                </span>
                              </th>
