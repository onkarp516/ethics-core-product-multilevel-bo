...
import TranxCategory from "./TranxCategory";
const uomoption = [
...
export default class TranxBrand extends Component {
  constructor(props) {
    super(props);
  ...
  // getsubcategoryOpt = (rowIndex, transactionDetailIndex) => {
  //   // debugger;
  //   let { lstPackages, rows } = this.props;
  //   let product_id = rows[rowIndex]["productId"]["value"];
  //   // console.log("Product Details------>", productDetails);
  ...
  //   }
  //   if (catOpt) {
  //     subcatOpt = getSelectValue(catOpt.categoryOpt, category_id);
  //   }

  //   // console.log("findProductPackges ==-->>????", findProductPackges);
  //   // console.log("pkgOpt", pkgOpt);
  //   return subcatOpt ? subcatOpt["subcategoryOpt"] : [];
  // };
  ...
  //     ];
  //   let subCategory_id =
  //     rows[rowIndex]["productDetails"][transactionDetailIndex]["subCategoryId"][
  //       "value"
  //     ];
  //   let findProductPackges;
  //   let catOpt;
  ...
  //   if (subcatOpt) {
  //     flavourOpt = getSelectValue(subcatOpt.subcategoryOpt, subCategory_id);
  //   }
  //   // console.log("findProductPackges ==-->>????", findProductPackges);
  //   // console.log("pkgOpt", pkgOpt);
  ...
  // getsubcategoryElement = (rowIndex, transactionDetailIndex, element) => {
  //   // debugger;
  //   let { rows } = this.props;
  //   // console.log(" unitIndex, element", unitIndex, element);
  //   // console.log({ rows });
